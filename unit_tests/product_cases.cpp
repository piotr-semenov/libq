...
#define fmax(type) double(std::numeric_limits<type>::max())
    ...
    {
        typedef SOU_fixed_point<31, 13>::type type1;
        typedef UOU_fixed_point<29, 17>::type type2;
    ...
    {
        typedef UOU_fixed_point<31, 16>::type type1;
        typedef SOU_fixed_point<32, 16>::type type2;
    ...
    {
        typedef UOU_fixed_point<7, 0>::type type;
        ...
        typedef UO_fixed_point<64, 0>::type type1;
