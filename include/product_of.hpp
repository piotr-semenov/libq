...
#ifndef INC_CORE_PRODUCT_HPP_
#define INC_CORE_PRODUCT_HPP_
...
namespace libq {
    ...
    class product_of<fixed_point<T1, n1, f1, op1, up1>, fixed_point<T2, n2, f2, op2, up2> >
    {
    ...
    public:
        ...
        typedef typename if_<is_closed,
            ...
            fixed_point<word_type, n1 + n2, f1 + f2, op1, up1>
        >::type type;
    };
}
