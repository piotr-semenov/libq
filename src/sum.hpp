/// @brief provides info class about sum result type

#ifndef INC_CORE_SUM_INFO_HPP_
#define INC_CORE_SUM_INFO_HPP_
...
namespace core {
    ...
    template<typename T, size_t n, size_t f, class op, class up>
    class sum<fixed_point<T, n, f, op, up> >
    {
        ...
        struct word_type_info
        {
            ...
            // in case if sum type is closed under arithmetic operations
            struct cl
            {
                typedef T type;
            };
    ...
    public:
        ...
        typedef typename if_<is_closed, operand_type, fixed_point<word_type, n + 1u,
            f, op, up> >::type type;
    };
}
