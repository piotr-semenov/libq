...
class acos_of<libq::fixed_point<T, n, f, e, op, up> >
    ...
    , public type_promotion_base<libq::fixed_point<T, 0, f, e, op, up>, 3u, 0, 0>
{};
...
/** @brief Example 1: "how-to" to improve the performance of the array initialization
...
#pragma unroll
    ...
    return
        is_negative ? result_type(result_type::CONST_PI - std::fabs(z)) :
